...
### ORC SC is developing a Joint Statement
...
- Plan: this will be brought before ORC steering committee early next week. 
  - It could have additional signatories (reach out to Juan if interested). 
  - If approved & supported, then would be posted publicly via social media, maybe press release, and sent to EC directly.  
- Notes  
  ...
  - Æva \- could we avoid bikeshedding in the document by keeping funding comments general?  
  - Jordan \- perhaps we should, maybe not in this letter but elsewhere, articulate the need for flexibility in funding models.  
...
- Æva presented the work we are doing, though there is no public link to the contents of the EG meeting
- Some minimal comments received 
  - Under the MSR, Third-party attestations (e.g., by an independent testing laboratory) are perceived as more reliable than a manufacturer’s own statements, but this is not the case for open source. We may want to incorporate some clarification about this into our outputs.  
- The presentation depicted how attestation could support manufacturers' due diligence obligations.  
  - Mathias asks whether there was a discussion about due diligence regarding 3rd party components, and whether any additional clarity was received. This discussion was brief, and continued in the following section.
...
- **A lengthy group discussion followed...**  
...
- SJN and Æva both presenting in Berlin / at FOSS Backstage next week. Others are encouraged to go to their sessions and continue the conversations in person.
